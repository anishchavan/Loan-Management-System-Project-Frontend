...
export class EnquiryService {
  ...
  saveApplicant(enquire: Enquiry) {
    return this.http.post(
      'http://localhost:8080/consumer/register/applicant',
      enquire
    );
  }
  ...
  getPendingEnquiries() {
    return this.http.get(
      'http://localhost:8080/consumer/register/enquiries/pending'
    );
  }
  checkCibil(enquiry: Enquiry) {
    return this.http.put(
      'http://localhost:8081/CheckCIBIL/' + enquiry.applicantId,
      enquiry
    );
  }
